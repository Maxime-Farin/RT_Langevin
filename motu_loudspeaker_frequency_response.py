...
impulse = np.zeros([ceil(m.RATE*duree), len(ChannelsOut)], dtype = np.float)
...
savefilename = "20180125_Frequency_response_loudspeaker_" + str(ChannelsOut[0]+1)
data = {'freq': freq, 'Amplitude_Spectrum': xF, 'time': time_impulse, 'impulse': impulse}
